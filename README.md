...
```bash
$ npm i -g webpack@1.x webpack-dev-server@1.x  //安装指定版本的webpack和webpack-dev-server
$ npm install webpack webpack-dev-server   //不指定版本
```
...
Visit http://127.0.0.1:8080 with your browser.有时候 localhost:8080并不行
